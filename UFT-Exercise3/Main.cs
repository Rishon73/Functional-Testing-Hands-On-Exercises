    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity12Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>b096cef0-34f2-470f-8180-e00b33ca4acc</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>AddAccounts!Sheet1</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>False</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value>AddAccounts</Value></QueryParameter><QueryParameter><Name>FilePath</Name><Value>" + _context.ResourceManager.GetValue("{AddAccounts!Sheet1.TablePath}") + "</Value></QueryParameter><QueryParameter><Name>SheetName</Name><Value>Sheet1$</Value></QueryParameter><QueryParameter><Name>ContainsHeadersRow</Name><Value>True</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.dataSourceNameToDataSource.Add("AddAccounts!Sheet1", _flow.DataFetchActivity12);
            ...
            VTDPropertyInfoBase pi177 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter89 = new VTDObjectGetter(pi177);
            VTDPropertyInfoBase pi178 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter89 = new VTDObjectSetter(pi178);
            binding_setter89 = new StringFormaterDecorator(binding_setter89,"{Step.DataFetchActivity12.OutTable}");
            bind_dir89 = new BindDirection(_flow.DataFetchActivity12,binding_getter89,binding_setter89,BindTargetType.ToInProperty);
            _flow.DataExporterActivity14.InDirections.Add(bind_dir89);
            ...
            VTDPropertyInfoBase pi179 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter90 = new VTDObjectGetter(pi179);
            VTDPropertyInfoBase pi180 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter90 = new VTDObjectSetter(pi180);
            binding_setter90 = new StringFormaterDecorator(binding_setter90,"{Step.DataFetchActivity12.OutTable}");
            bind_dir90 = new BindDirection(_flow.DataFetchActivity12,binding_getter90,binding_setter90,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity13.InDirections.Add(bind_dir90);
            this.Activities.Add (_flow.DataDisconnectActivity13);
            this.DataCursorActivity16.Comment = @"";
            this.DataCursorActivity16.IconPath = @"";
            VTDPropertyInfoBase pi181 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter91 = new VTDObjectGetter(pi181);
            VTDPropertyInfoBase pi182 = new VTDPropertyInfoBase("InTable");
            VTDBaseSetter binding_setter91 = new VTDObjectSetter(pi182);
            binding_setter91 = new StringFormaterDecorator(binding_setter91,"{Step.DataFetchActivity12.OutTable}");
            bind_dir91 = new BindDirection(_flow.DataFetchActivity12,binding_getter91,binding_setter91,BindTargetType.ToInProperty);
            this.DataCursorActivity16.InDirections.Add(bind_dir91);
            ...
            this.DataCursorActivity16_Policy.EndAtSpecificRow = 5;
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><AccountCreateRequest xmlns=""com.advantage.online.store.accountservice""><lastName>{DataSource.AddAccounts!Sheet1.LastName}</lastName><firstName>{DataSource.AddAccounts!Sheet1.FirstName}</firstName><loginName>{DataSource.AddAccounts!Sheet1.LoginName}</loginName><countryId>40</countryId><stateProvince /><cityName /><address /><zipcode /><phoneNumber /><email>{DataSource.AddAccounts!Sheet1.Email}</email><password>{DataSource.AddAccounts!Sheet1.Password}</password><accountType>20</accountType><allowOffersPromotion>true</allowOffersPromotion></AccountCreateRequest></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi183 = new VTDPropertyInfoBase("Password");
            VTDBaseGetter binding_getter92 = new VTDObjectGetter(pi183);
            VTDPropertyInfoBase pi184 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='password'][1]");
            VTDBaseSetter binding_setter92 = new VTDXPathSetter(pi184,XmlTypeCode.String);
            binding_setter92 = new StringFormaterDecorator(binding_setter92,"{DataSource.AddAccounts!Sheet1.Password}");
            bind_dir92 = new BindDirection(this.DataCursorActivity16,binding_getter92,binding_setter92,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir92);
            VTDPropertyInfoBase pi185 = new VTDPropertyInfoBase("LoginName");
            VTDBaseGetter binding_getter93 = new VTDObjectGetter(pi185);
            VTDPropertyInfoBase pi186 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='loginName'][1]");
            VTDBaseSetter binding_setter93 = new VTDXPathSetter(pi186,XmlTypeCode.String);
            binding_setter93 = new StringFormaterDecorator(binding_setter93,"{DataSource.AddAccounts!Sheet1.LoginName}");
            bind_dir93 = new BindDirection(this.DataCursorActivity16,binding_getter93,binding_setter93,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir93);
            VTDPropertyInfoBase pi187 = new VTDPropertyInfoBase("LastName");
            VTDBaseGetter binding_getter94 = new VTDObjectGetter(pi187);
            VTDPropertyInfoBase pi188 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='lastName'][1]");
            VTDBaseSetter binding_setter94 = new VTDXPathSetter(pi188,XmlTypeCode.String);
            binding_setter94 = new StringFormaterDecorator(binding_setter94,"{DataSource.AddAccounts!Sheet1.LastName}");
            bind_dir94 = new BindDirection(this.DataCursorActivity16,binding_getter94,binding_setter94,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir94);
            VTDPropertyInfoBase pi189 = new VTDPropertyInfoBase("FirstName");
            VTDBaseGetter binding_getter95 = new VTDObjectGetter(pi189);
            VTDPropertyInfoBase pi190 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='firstName'][1]");
            VTDBaseSetter binding_setter95 = new VTDXPathSetter(pi190,XmlTypeCode.String);
            binding_setter95 = new StringFormaterDecorator(binding_setter95,"{DataSource.AddAccounts!Sheet1.FirstName}");
            bind_dir95 = new BindDirection(this.DataCursorActivity16,binding_getter95,binding_setter95,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir95);
            VTDPropertyInfoBase pi191 = new VTDPropertyInfoBase("Email");
            VTDBaseGetter binding_getter96 = new VTDObjectGetter(pi191);
            VTDPropertyInfoBase pi192 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='email'][1]");
            VTDBaseSetter binding_setter96 = new VTDXPathSetter(pi192,XmlTypeCode.String);
            binding_setter96 = new StringFormaterDecorator(binding_setter96,"{DataSource.AddAccounts!Sheet1.Email}");
            bind_dir96 = new BindDirection(this.DataCursorActivity16,binding_getter96,binding_setter96,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir96);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><AddSafePayMethodRequest xmlns=""com.advantage.online.store.accountservice""><accountId>{Step.OutputProperties.StServiceCallActivity4.Body.AccountCreateResponse.StatusMessage.userId}</accountId><safePayUsername>{Step.InputProperties.StServiceCallActivity4.Body.AccountCreateRequest.loginName}</safePayUsername><safePayPassword>{Step.InputProperties.StServiceCallActivity4.Body.AccountCreateRequest.password}</safePayPassword><base64Token>{Step.OutputProperties.StServiceCallActivity4.Body.AccountCreateResponse.StatusMessage.userId}</base64Token></AddSafePayMethodRequest></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi193 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='loginName'][1]");
            VTDBaseGetter binding_getter97 = new VTDXPathGetter(pi193,XmlTypeCode.String);
            VTDPropertyInfoBase pi194 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AddSafePayMethodRequest'][1]/*[local-name(.)='safePayUsername'][1]");
            VTDBaseSetter binding_setter97 = new VTDXPathSetter(pi194,XmlTypeCode.String);
            binding_setter97 = new StringFormaterDecorator(binding_setter97,"{Step.InputProperties.StServiceCallActivity4.Body.AccountCreateRequest.loginName}");
            bind_dir97 = new BindDirection(_flow.StServiceCallActivity4,binding_getter97,binding_setter97,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir97);
            VTDPropertyInfoBase pi195 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateRequest'][1]/*[local-name(.)='password'][1]");
            VTDBaseGetter binding_getter98 = new VTDXPathGetter(pi195,XmlTypeCode.String);
            VTDPropertyInfoBase pi196 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AddSafePayMethodRequest'][1]/*[local-name(.)='safePayPassword'][1]");
            VTDBaseSetter binding_setter98 = new VTDXPathSetter(pi196,XmlTypeCode.String);
            binding_setter98 = new StringFormaterDecorator(binding_setter98,"{Step.InputProperties.StServiceCallActivity4.Body.AccountCreateRequest.password}");
            bind_dir98 = new BindDirection(_flow.StServiceCallActivity4,binding_getter98,binding_setter98,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir98);
            VTDPropertyInfoBase pi197 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateResponse'][1]/*[local-name(.)='StatusMessage'][1]/*[local-name(.)='userId'][1]");
            VTDBaseGetter binding_getter99 = new VTDXPathGetter(pi197,XmlTypeCode.Long);
            VTDPropertyInfoBase pi198 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AddSafePayMethodRequest'][1]/*[local-name(.)='base64Token'][1]");
            VTDBaseSetter binding_setter99 = new VTDXPathSetter(pi198,XmlTypeCode.String);
            binding_setter99 = new StringFormaterDecorator(binding_setter99,"{Step.OutputProperties.StServiceCallActivity4.Body.AccountCreateResponse.StatusMessage.userId}");
            bind_dir99 = new BindDirection(_flow.StServiceCallActivity4,binding_getter99,binding_setter99,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir99);
            VTDPropertyInfoBase pi199 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateResponse'][1]/*[local-name(.)='StatusMessage'][1]/*[local-name(.)='userId'][1]");
            VTDBaseGetter binding_getter100 = new VTDXPathGetter(pi199,XmlTypeCode.Long);
            VTDPropertyInfoBase pi200 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AddSafePayMethodRequest'][1]/*[local-name(.)='accountId'][1]");
            VTDBaseSetter binding_setter100 = new VTDXPathSetter(pi200,XmlTypeCode.Long);
            bind_dir100 = new BindDirection(_flow.StServiceCallActivity4,binding_getter100,binding_setter100,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir100);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><AccountDeleteRequest xmlns=""com.advantage.online.store.accountservice""><accountId>{Step.OutputProperties.StServiceCallActivity4.Body.AccountCreateResponse.StatusMessage.userId}</accountId><base64Token>{Step.OutputProperties.StServiceCallActivity4.Body.AccountCreateResponse.StatusMessage.userId}</base64Token></AccountDeleteRequest></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi201 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateResponse'][1]/*[local-name(.)='StatusMessage'][1]/*[local-name(.)='userId'][1]");
            VTDBaseGetter binding_getter101 = new VTDXPathGetter(pi201,XmlTypeCode.Long);
            VTDPropertyInfoBase pi202 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountDeleteRequest'][1]/*[local-name(.)='base64Token'][1]");
            VTDBaseSetter binding_setter101 = new VTDXPathSetter(pi202,XmlTypeCode.String);
            binding_setter101 = new StringFormaterDecorator(binding_setter101,"{Step.OutputProperties.StServiceCallActivity4.Body.AccountCreateResponse.StatusMessage.userId}");
            bind_dir101 = new BindDirection(_flow.StServiceCallActivity4,binding_getter101,binding_setter101,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity10.InDirections.Add(bind_dir101);
            VTDPropertyInfoBase pi203 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountCreateResponse'][1]/*[local-name(.)='StatusMessage'][1]/*[local-name(.)='userId'][1]");
            VTDBaseGetter binding_getter102 = new VTDXPathGetter(pi203,XmlTypeCode.Long);
            VTDPropertyInfoBase pi204 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='AccountDeleteRequest'][1]/*[local-name(.)='accountId'][1]");
            VTDBaseSetter binding_setter102 = new VTDXPathSetter(pi204,XmlTypeCode.Long);
            bind_dir102 = new BindDirection(_flow.StServiceCallActivity4,binding_getter102,binding_setter102,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity10.InDirections.Add(bind_dir102);
